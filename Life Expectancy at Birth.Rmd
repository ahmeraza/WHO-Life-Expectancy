---
title: 'Assignment A2.2: Life Expectancy at Birth'
author: "MBAN2 Team7"
date: "2025-02-13"
output:
...
df_females <- read.csv("data/Females.csv", skip=4, stringsAsFactors=FALSE, check.names=TRUE)
...
ggplot(df_combined, aes(x = Year)) +
  ...
  facet_wrap(~ Continent) +  # Split by continent
    # Labels & Titles
  labs(
    title = "Life Expectancy Trends by Gender and Continent (1960–2022)",
